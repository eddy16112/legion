...
/*static*/
void CalcNewCurrentsTask::cpu_base_impl(const Task *task, const CircuitPiece &piece,
...
int dist_sleep_i = 0;
/*static*/
void DistributeChargeTask::cpu_base_impl(const Task *task, const CircuitPiece &p,
                                         const std::vector<PhysicalRegion> &regions,
                                         Context ctx, Runtime* rt)
{
...
int update_sleep_i = 0;
/*static*/
void UpdateVoltagesTask::cpu_base_impl(const Task *task, const CircuitPiece &p,
                                       const std::vector<PhysicalRegion> &regions,
                                       Context ctx, Runtime* rt)
{
